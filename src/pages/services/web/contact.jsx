        ...
        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-200 dark:border-gray-700 "
                  />
                </div>
                <div>
                  <label
                  ...
                  <input
                    ...
                    className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-200 "
                  />
                </div>
              </div>
              {/* End Grid */}
          ...
          {messageStatus == 'sent' && (
                      <p className="text-sm text-blue-500 ">
                        {' '}
                        Your form request has been sent. We'll get back to you in 1-2 business days.{' '}
                      </p>
                    )}
